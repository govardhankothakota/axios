...
function EditProfile() {
  ...
  let populateUserDetails = () => {
    firstNameInputRef.current.value = storeObj.loginReducer.loginDetails.firstName;
    ...
    mobileNoInputRef.current.value = storeObj.loginReducer.loginDetails.mobileNo;
    setprofilePic(`http://localhost:13189/${storeObj.loginReducer.loginDetails.profilePic}`);
  };
